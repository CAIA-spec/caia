...
- Truthful, minimal specification of system behavior
...
### 4.4 Interoperability Scope

This specification does not define interoperability between independently
implemented systems or modules.

At the time of this specification, no interoperability profiles or certification
programs are defined. Conformance to this specification alone does not imply
interoperability with other CAIA-conformant systems or modules.
